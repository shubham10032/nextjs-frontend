...
export const CarLoanListLayout = ({item}) => {
    return <>
                    ...
                    <div className="col-lg-10 col-md-12">
                        <div className="xcard-charges x-loan">
                            ...
                            <div className="xcard-charge-join">
                                ...
                                <div className="trav">{JSON.parse(item.bankProductInfo)['loan_amt_minimum'] ? JSON.parse(item.bankProductInfo)['cibil_minimum'] : 'N/A'} or above</div>
                            </div>
                        </div>
                    </div>
                </div>
